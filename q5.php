...
'E' => 'Players on the other team are allowed to gesture over video (or type non-substantive text, such as “raising buzzer”) to signal to teammates that they intend to buzz in later.',
]);
