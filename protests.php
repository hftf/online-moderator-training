...
<ul>
	<li><p>If a team protests, you or your scorekeeper should <mark>quickly take note in the scoresheet</mark> of what is being protested (in general terms) and how the score would change if the protest were upheld.</p></li>
	<li><p><mark>You are not responsible for resolving protests</mark>, so don’t get into a long debate with players about whether a protest is right or wrong. Note the protest in the scoresheet and move on.</p></li>
